...
function(t, n, o, r, l) {
    ...
    qLbD3: [function(e, t, n) {
        var o = e("@parcel/transformer-js/src/esmodule-helpers.js");
        o.defineInteropFlag(n), 
        o.export(n, "config", () => r), 
        e("../assets/css/content-script.css"), 
        console.log("Clippings.io amazon-contentscript loaded");
        
        let r = {
            matches: ["https://read.amazon.com/*", "https://read.amazon.co.jp/*"]
        };
        
        (() => {
            try {
                let e = document.getElementById("kp-notebook-head");
                if (e && !document.getElementById("banner")) {
                    // Creating banner
                    let t = document.createElement("div");
                    t.id = "banner", 
                    t.classList.add("banner"), 
                    t.style.backgroundColor = "#eaddcf", 
                    t.style.padding = "1rem", 
                    t.style.marginBottom = "1rem";
                    
                    // Banner text parts
                    let n = document.createElement("div");
                    n.innerHTML = "Click the ", 
                    n.style.color = "black", 
                    n.style.fontSize = "1.2rem";
                    
                    let o = document.createElement("div");
                    o.innerHTML = " Icon on the toolbar to import your Kindle Highlights 👆", 
                    o.style.color = "black", 
                    o.style.fontSize = "1.2rem";
                    
                    // Logo image
                    let r = document.createElement("img");
                    r.src = chrome.runtime.getURL("assets/images/logo_black_32_32.svg"), 
                    r.style.paddingLeft = "0.5rem", 
                    r.style.paddingRight = "0.5rem";
                    
                    // Close button
                    let l = document.createElement("div");
                    l.classList.add("closebutton"), 
                    l.innerHTML = "x", 
                    l.style.color = "black", 
                    l.style.fontSize = "1.2rem", 
                    l.style.paddingLeft = "1rem", 
                    l.style.alignContent = "top", 
                    l.onclick = () => {
        ...
        "../assets/css/content-script.css": "hNaho",
        "@parcel/transformer-js/src/esmodule-helpers.js": "fRZO2"
    }],
    hNaho: [function() {}, {}],
    fRZO2: [function(e, t, n) {
